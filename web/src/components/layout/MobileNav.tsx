            ...
            <div className="md:hidden fixed bottom-0 left-0 right-0 z-[100] px-4 pb-6 pt-2 pointer-events-none">
                ...
                >
                    ...
                    >
                        ...
                        <span className={cn(
                            "text-[8px] font-black uppercase tracking-widest leading-none",
                            profileOpen ? "text-primary" : "text-white/20"
                        )}>
                            Profile
                        </span>
                    </button>
                    ...
                    >
                        <motion.div
                            whileTap={{ scale: 0.9 }}
                            className="p-2 rounded-2xl transition-all text-red-500/50 group-hover:text-red-500"
                        >
                            <LogOut className="w-6 h-6" />
                        </motion.div>
                        <span className="text-[8px] font-black uppercase tracking-widest leading-none text-red-500/30">
                            Exit
                        </span>
                    </button>
                </motion.nav>
