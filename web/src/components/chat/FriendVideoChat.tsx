      ...
      <header className="absolute top-8 inset-x-0 h-20 md:h-24 z-[70] px-6 md:px-12 flex items-center justify-center pointer-events-none">
        <div className="w-full max-w-[1700px] flex items-center justify-between">
          ...
          <div className="pointer-events-auto">
            <Button
              onClick={handleClose}
              className="rounded-3xl px-8 md:px-12 h-14 md:h-16 font-black uppercase tracking-widest text-[11px] shadow-[0_20px_40px_rgba(239,68,68,0.2)] bg-red-500 hover:bg-red-600 border-none transition-all hover:scale-105 active:scale-95"
            >
              END VIBE
            </Button>
          </div>
        ...
        <div className="w-full h-full max-w-[1700px] flex flex-col md:flex-row gap-6 md:gap-10 items-center justify-center pt-24 md:pt-32 relative z-10 overflow-hidden">
          ...
          >
            <VideoPanel
              ...
              className={cn(
                "w-full h-full border-none transition-transform duration-700 group-hover:scale-[1.02]",
            ...
            <div className="absolute inset-x-0 bottom-0 p-10 bg-gradient-to-t from-black via-black/40 to-transparent">
              <p className="text-[12px] font-black uppercase tracking-[0.5em] text-white/50 italic">
                You (Exclusive)
              </p>
            </div>
          </motion.div>
          ...
          >
            <VideoPanel
              isMatched={session.isMatched}
              className="w-full h-full border-none transition-transform duration-700 group-hover:scale-[1.02]"
            />
            <div className="absolute inset-x-0 bottom-0 p-10 bg-gradient-to-t from-black via-black/40 to-transparent flex justify-between items-end">
              <div className="flex flex-col gap-2">
                <h3 className="text-3xl font-black italic uppercase tracking-tighter text-white leading-none">
                  {session.peerName || "Buddy"}
                </h3>
                <div className="flex items-center gap-2">
                  <Zap className="w-3 h-3 text-emerald-400 animate-pulse" />
                  <span className="text-[10px] font-black uppercase tracking-[0.3em] text-emerald-500/80 leading-none">
                    Vibe Established
                  </span>
                </div>
              </div>
