...
export function LandingClient({ initialSession }: { initialSession: any }) {
  ...
  const features = [
    {
      ...
      description:
        "Our proprietary AI runs entirely in your browser. Sensitive content is flagged before it ever leaves your device.",
    },
    {
      icon: <Lock className="w-8 h-8 text-emerald-400" />,
      title: "P2P Encryption",
      description:
        "Video streams are direct and end-to-end encrypted. No middleman, no recording, zero data retention.",
    },
    {
      icon: <Heart className="w-8 h-8 text-pink-500" />,
      title: "Social Persistence",
      description:
        "Met someone cool? Add them as a friend to persist the vibe in the social feed and private DMs.",
    },
    {
      icon: <Zap className="w-8 h-8 text-amber-400" />,
      title: "Atomic Matchmaking",
      description:
        "High-performance Redis logic ensures you're never waiting. Connect with the world in milliseconds.",
    },
  ];
  ...
  return (
    <main>
      ...
      <section className="relative pt-32 pb-12 md:pt-48 lg:pt-64 lg:pb-32 flex flex-col items-center z-10 px-4">
        ...
        >
          ...
          >
            ...
            <span className="text-[8px] md:text-[10px] font-black uppercase tracking-[0.2em] md:tracking-[0.4em] opacity-60">
          ...
          >
            Match<span className="text-primary italic">.</span>
            <br />
            Connect.
            <br />
            Vibe.
          ...
          >
            <Link
              href={effectiveSession ? "/chat" : "/login"}
            ...
            >
              ...
              >
                <Button
                  size="lg"
                  className="w-full sm:w-auto rounded-[1.5rem] md:rounded-[2.5rem] px-8 md:px-20 h-20 md:h-28 font-black text-xl md:text-3xl bg-primary hover:bg-primary shadow-glow-lg transition-all group overflow-hidden relative border-none shimmer"
                >
      ...
      <section
        id="features"
        className="py-20 md:py-32 relative z-10 bg-gradient-to-b from-transparent via-white/[0.02] to-transparent px-4"
      >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            {features.map((feature, idx) => (
              ...
              >
                ...
                <h3 className="text-lg md:text-xl font-black uppercase tracking-tight mb-3 md:mb-4">
                  {feature.title}
                </h3>
      ...
      <section
        id="safety"
        className="py-24 md:py-48 relative overflow-hidden px-4"
      >
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 md:gap-24">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed font-medium">
                We believe your face is your data. Unlike legacy platforms,
                VibeChat doesn't "cloud scan" your private video calls. Our AI
                identifies harmful content locally, on your device hardware,
              ...
              <ul className="space-y-3 md:space-y-4">
                {[
                  ...
                  <li
                    key={i}
                    className="flex items-center gap-3 md:gap-4 text-[10px] md:text-sm font-black uppercase tracking-widest text-foreground/80"
                  >
            ...
            >
              <Card className="aspect-square rounded-[2rem] md:rounded-[4rem] border border-border p-8 md:p-12 relative overflow-hidden shadow-glow-lg">
                <div className="relative h-full flex flex-col justify-center items-center text-center space-y-6 md:space-y-8">
                  ...
                  <div className="space-y-1 md:space-y-2">
                    ...
                    <p className="text-emerald-400 font-mono text-[8px] md:text-xs tracking-widest">
                      CONNECTION STATUS: ANONYMOUS
                    </p>
                  </div>
                </div>
