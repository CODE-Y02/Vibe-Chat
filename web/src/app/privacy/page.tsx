                ...
                <div className="glass-card p-8 md:p-12 rounded-[2rem] border border-border relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-4 mb-8">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground font-medium tracking-widest text-sm uppercase mt-1">Last Updated: March 2026</p>
                        </div>
                    </div>
                    ...
                    <div className="prose prose-invert max-w-none space-y-8 text-foreground/70">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-foreground mb-4">4. GDPR & CCPA Compliance</h2>
                            <p>
