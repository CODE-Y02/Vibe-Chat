...
class WebRTCClient {
  ...
  async ensureLocalStream() {
    ...
    // If we reach here, we need to trigger setup.
    // Note: This usually happens via VideoPanel, but we'll guard it here.
  ...
  private async processQueuedCandidates() {
    console.log(
      `[WebRTC] Flushing ${this.iceCandidatesQueue.length} queued candidates.`,
    );
